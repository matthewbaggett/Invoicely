...
require_once __DIR__ . '/includes/invoicely.inc';
...
if (theme_get_setting('invoicely_rebuild_registry') && !defined('MAINTENANCE_MODE')) {
  // Rebuild .info data.
 ...
 */
function invoicely_theme(&$existing, $type, $theme, $path) {
  ...
  if (
    ...
    && theme_get_setting('invoicely_rebuild_registry')
  ...
  return array(
    ...
    'invoicely_search_form_wrapper' => array(
      'render element' => 'element',
    ),
    'invoicely_append_element' => array(
      'render element' => 'element',
    ),
  );
}
 ...
 */
function invoicely_breadcrumb($variables) {
 ...
 */
function invoicely_process_html_tag(&$variables) {
 ...
 */
function invoicely_menu_tree__primary(&$variables) {
 ...
 */
function invoicely_menu_tree__secondary(&$variables) {
 ...
 */
function invoicely_menu_local_action($variables) {
 ...
 * @see region.tpl.php
 */
function invoicely_preprocess_region(&$variables, $hook) {
 ...
 * @see block.tpl.php
 */
function invoicely_preprocess_block(&$variables, $hook) {
 ...
 */
function invoicely_process_block(&$variables, $hook) {
 ...
 * @ingroup themable
 */
function invoicely_invoicely_search_form_wrapper(&$variables) {
  $output = '<div class="input-group">';
  $output .= $variables['element']['#children'];
  $output .= '<span class="input-group-btn">';
  $output .= '<button type="submit" class="btn btn-default">';
  if (module_exists('icon')) {
    $output .= theme('icon', array('bundle' => 'invoicely', 'icon' => 'glyphicon-search'));
  }
  // We can be sure that the font icons exist in CDN.
  elseif (theme_get_setting('invoicely_cdn')) {
 ...
 *
 * invoicely need additional class glyphicon to display icons
 *
 * @see icon_preprocess_icon_image()
 * @see template_preprocess_icon()
 */
function invoicely_preprocess_icon(&$variables) {
