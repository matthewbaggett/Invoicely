...
/**
 * invoicely theme wrapper function for the primary menu links
 */
...
/**
 * invoicely theme wrapper function for the secondary menu links
 */
 ...
 * with invoicely to the action links.
 *
 * @param $variables
 ...
 */
function _invoicely_content_span($columns = 1) {
  $class = FALSE;
