...
function invoicely_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  $form['themedev']['invoicely_rebuild_registry'] = array(
    '#type'          => 'checkbox',
  ...
  $form['cdn']['cdn_invoicely_version_container'] = array(
    '#type' => 'container',
    '#states' => array(
      'invisible' => array(
       ':input[name="cdn_invoicely"]' => array('checked' => FALSE),
      ),
    ),
  );

  $form['cdn']['cdn_invoicely_version_container']['cdn_invoicely_version'] = array(
    '#type' => 'select',
    '#title' => t('invoicely version'),
    '#options' => array(
      '2.3.2' => 'v2.3.2',
      '2.3.1' => 'v2.3.1',
      '2.3.0' => 'v2.3.0',
    ...
    '#default_value' => theme_get_setting('cdn_invoicely_version'),
  );
